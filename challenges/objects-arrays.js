...
let universities = graduates.map(function (graduates) {
  return graduates.university.split();
});
...
const contactInfo = []; 
graduates.forEach(function(graduates,index){
...
// const runnersLargeSizeShirt = runners.filter(function(runners){
...
*/
const displayNames = [];
zooAnimals.forEach(function(zooAnimals,index){
...
const populationTotal = zooAnimals.reduce(function(accumulator, zooAnimals){
  return accumulator + zooAnimals.population;},0);
